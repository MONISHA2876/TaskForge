  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
        ...
        <span style={{ fontSize: "12px", fontWeight: 700, color: "#ffffff" }}>Morning Wellness Plan</span>
        <span style={{
        ...
        {[
          ...
          <div key={t.title} style={{
            ...
            <div style={{
              ...
              background: t.done ? "rgba(255,255,255,0.9)" : "rgba(255,255,255,0.15)",
              border: t.done ? "none" : "1.5px solid rgba(255,255,255,0.3)",
              display: "flex", alignItems: "center", justifyContent: "center",
            }}>
              {t.done && (
                <svg viewBox="0 0 10 10" width="8" height="8">
                  <polyline points="2,5 4,7.5 8,2.5" stroke="#4F46E5" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              )}
            </div>
            <span style={{
            ...
            <span style={{ fontSize: "10px", color: "rgba(255,255,255,0.4)" }}>{t.time}</span>
          </div>
        ))}
      </div>
      {/* Progress bar */}
      <div style={{ marginTop: "10px" }}>
        <div style={{ height: "4px", background: "rgba(255,255,255,0.12)", borderRadius: "99px", overflow: "hidden" }}>
          <div style={{ width: "67%", height: "100%", background: "rgba(255,255,255,0.7)", borderRadius: "99px" }} />
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", marginTop: "4px" }}>
          <span style={{ fontSize: "10px", color: "rgba(255,255,255,0.4)" }}>2 of 3 done</span>
          <span style={{ fontSize: "10px", fontWeight: 700, color: "rgba(255,255,255,0.7)" }}>67%</span>
        </div>
      </div>
    </motion.div>
  );
    ...
    <div style={{
        ...
        >
          ...
          <div style={{ marginBottom: "32px" }}>
            ...
            <p style={{ fontSize: "14px", color: "#9CA3AF" }}>
              ...
              <Link href="/auth/signin" style={{ color: "#4F46E5", fontWeight: 600, textDecoration: "none" }}>
                Sign in
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                      ...
                      {[1, 2, 3, 4].map((step) => (
                        <div
                          ...
                          style={{
                            ...
                            background: strength.score >= step ? strength.color : "#E5E7EB",
            ...
            <motion.button
              ...
              style={{
                ...
                background: submitting ? "#E5E7EB" : "linear-gradient(135deg, #7C3AED, #4F46E5)",
      ...
      <motion.div
        ...
        style={{
          ...
          background: "linear-gradient(145deg, #7C3AED 0%, #4F46E5 60%, #4338CA 100%)",
      ...
      >
        ...
        >
          <h1 style={{
            ...
            Build a smarter<br />
            <span style={{ color: "rgba(255,255,255,0.6)" }}>routine from day one.</span>
          </h1>

          <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.65)", lineHeight: 1.65, marginBottom: "36px", maxWidth: "340px" }}>
            Join thousands of people using TaskForge to plan their days, track goals, and stay consistently productive.
          </p>
        ...
        >
          <div style={{ display: "flex" }}>
            {["AJ", "MR", "SK", "PL"].map((initials, i) => (
              <div
                key={initials}
                style={{
                  width: "32px", height: "32px", borderRadius: "50%",
                  background: `hsl(${220 + i * 30}, 70%, 65%)`,
          ...
          <div>
            <p style={{ fontSize: "12.5px", fontWeight: 700, color: "#ffffff" }}>
              2,400+ plans created
            </p>
