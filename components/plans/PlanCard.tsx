...
export function PlanCard({ plan, stats, onDelete }: PlanCardProps) {
  const badge = planTypeBadge[plan.planType] ?? { bg: "#F3F4F6", color: "#374151" };
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "16px", marginBottom: "20px", paddingTop: "4px" }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          <h3 style={{ fontSize: "18px", fontWeight: 700, color: "#111827", letterSpacing: "-0.4px", lineHeight: 1.3, marginBottom: "8px" }}>
            {plan.heading}
          </h3>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "12px", marginBottom: "20px" }}>
        {[
          ...
          <div key={m.label} style={{
            ...
            <div style={{ fontSize: "16px", fontWeight: 700, color: "#111827", marginBottom: "4px" }}>{m.value}</div>
      ...
      {stats.nextTask && (
        <div style={{
          ...
          background: "#EEF2FF", borderRadius: "12px", border: "1px solid #C7D2FE",
        }}>
          <p style={{ fontSize: "10px", fontWeight: 700, color: "#4F46E5", textTransform: "uppercase", letterSpacing: "0.6px", marginBottom: "6px" }}>
            Next up
          </p>
          ...
          <p style={{ fontSize: "12px", color: "#9CA3AF" }}>
            {stats.nextTask.period} · {stats.nextTask.time} · {stats.nextTask.duration} · {stats.nextTask.taskType}
          </p>
        </div>
      )}
      ...
      <div style={{ display: "flex", gap: "10px" }}>
        <motion.button
          whileTap={{ scale: 0.97 }}
          style={{
            flex: 1, padding: "12px 0", fontSize: "13.5px", fontWeight: 700,
            background: "#4F46E5", color: "#ffffff", border: "none",
            borderRadius: "12px", cursor: "pointer", letterSpacing: "-0.1px",
          }}
        >
          Continue plan →
        </motion.button>
        ...
        <motion.button
          ...
          style={{
            padding: "12px 14px", background: "#ffffff", color: "#F87171",
